...
var _user$project$Main$flashViewElements = function (elements) {
	return A2(
		_elm_lang$core$List$map,
		function (elem) {
			return A2(
				_elm_lang$html$Html$div,
				{
					...
					_0: _elm_lang$html$Html_Attributes$class(
						A2(_elm_lang$core$Basics_ops['++'], 'alert alert-', elem.color)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$Main$durationString = function (val) {
	return _elm_lang$core$Native_Utils.eq(val, 0) ? '' : _elm_lang$core$Basics$toString(val);
};
var _user$project$Main$markTicketSelected = F3(
	function (ticket, id, userId) {
		return _elm_lang$core$Native_Utils.eq(ticket.id, id) ? _elm_lang$core$Native_Utils.update(
			ticket,
			{
...
var _user$project$Main$myTurn = function (model) {
	var currentUserName = function (_) {
		return _.name;
	}(
		A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$Main$nullUser,
			A2(_elm_lang$core$Array$get, model.currentUser, model.users)));
	return _elm_lang$core$Native_Utils.eq(currentUserName, model.myUserName);
};
var _user$project$Main$userNameFromId = F2(
	function (users, id) {
		return function (_) {
			return _.name;
		}(
...
var _user$project$Main$userIdFromName = F2(
	function (name, users) {
		return function (_) {
			return _.id;
		}(
...
var _user$project$Main$userField = F3(
	function (model, index, extractor) {
		return extractor(
			A2(
				_elm_lang$core$Maybe$withDefault,
				_user$project$Main$nullUser,
				A2(_elm_lang$core$Array$get, index, model.users)));
	});
...
var _user$project$Main$FlashElement = F4(
	function (a, b, c, d) {
		return {id: a, text: b, color: c, duration: d};
	});
var _user$project$Main$Ticket = F5(
	function (a, b, c, d, e) {
		return {id: a, date: b, opponent: c, time: d, userId: e};
	});
var _user$project$Main$ticketDecoder = A3(
		...
		A3(
			...
			A3(
				...
				A3(
					...
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Ticket))))));
...
var _user$project$Main$singleTicket = F3(
	function (ticket, myUserId, myTurn) {
		var innerDiv = A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
		...
		return myTurn ? A2(
			_elm_lang$html$Html$a,
			{
				...
				_0: _elm_lang$html$Html_Events$onClick(
					A2(_user$project$Main$SendMessage, ticket.id, myUserId)),
				_1: {
					ctor: '::',
...
var _user$project$Main$ticketList = F3(
	function (myUserId, myTurn, tickets) {
		return A2(
			_elm_lang$core$List$map,
			function (ticket) {
...
var _user$project$Main$remainingTickets = F3(
	function (tickets, myUserId, myTurn) {
		var remainingTickets = A2(
			_elm_lang$core$List$filter,
			function (ticket) {
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{ctor: '[]'},
						A3(_user$project$Main$ticketList, myUserId, myTurn, remainingTickets)),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$Main$myTickets = function (model) {
	var myTickets = A2(
		_elm_lang$core$List$filter,
		function (ticket) {
			return _elm_lang$core$Native_Utils.eq(
				ticket.userId,
				_elm_lang$core$Maybe$Just(model.myUserId));
		},
		model.tickets);
		...
		},
		{
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'My Tickets - ',
									_elm_lang$core$Basics$toString(ticketCount))),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					A3(_user$project$Main$ticketList, model.myUserId, false, myTickets)),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$joinChannel = A2(
	...
	_elm_lang$core$Task$succeed(_user$project$Main$JoinChannel));
...
var _user$project$Main$ProcessUserRequest = function (a) {
...
var _user$project$Main$usersRequest = function () {
	...
	return A2(
		...
		A2(_elm_lang$http$Http$get, url, _user$project$Main$userListDecoder));
}();
var _user$project$Main$ProcessTicketRequest = function (a) {
...
var _user$project$Main$ticketsRequest = function () {
	...
	return A2(
		...
		A2(_elm_lang$http$Http$get, url, _user$project$Main$ticketListDecoder));
}();
var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{
		...
		flashElements: {ctor: '[]'},
		nextId: 0,
		users: _elm_lang$core$Array$fromList(
			{ctor: '[]'}),
		currentUser: 0,
		myUserId: -1,
		myUserName: '',
...
var _user$project$Main$UpdateUserInputField = function (a) {
	return {ctor: 'UpdateUserInputField', _0: a};
};
var _user$project$Main$NextUser = {ctor: 'NextUser'};
var _user$project$Main$userPlusButton = function (model) {
	return {
		ctor: '::',
		_0: A2(
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$SubmitUserInputField),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(_elm_lang$core$Basics_ops['++'], 'Logged In: ', model.myUserName)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$NextUser),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _user$project$Main$flashView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Main$userPlusButton(model),
			_user$project$Main$flashViewElements(model.flashElements)));
};
...
var _user$project$Main$DeleteFlashElement = F2(
	function (a, b) {
		return {ctor: 'DeleteFlashElement', _0: a, _1: b};
	});
var _user$project$Main$deleteCmd = F2(
...
var _user$project$Main$CreateFlashElement = F3(
	function (a, b, c) {
		return {ctor: 'CreateFlashElement', _0: a, _1: b, _2: c};
	});
var _user$project$Main$createFlashElement = F3(
	function (message, color, duration) {
		return A2(
			_elm_lang$core$Task$perform,
			_elm_lang$core$Basics$identity,
			_elm_lang$core$Task$succeed(
				A3(_user$project$Main$CreateFlashElement, message, color, duration)));
	});
		...
		switch (_p1.ctor) {
			case 'NextUser':
				...
				return A2(
						...
						{currentUser: nextUser}),
					{
						ctor: '::',
						_0: A3(
							_user$project$Main$createFlashElement,
							A2(_elm_lang$core$Basics_ops['++'], nextUserName, '\'s turn'),
							color,
							20),
						_1: {ctor: '[]'}
					});
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							myUserId: A2(
								_user$project$Main$userIdFromName,
								model.userInputField,
								_elm_lang$core$Array$toList(model.users))
						}),
					{ctor: '[]'});
			case 'CreateFlashElement':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{flashElements: newList, nextId: model.nextId + 1}),
					{
						ctor: '::',
			...
			case 'SendMessage':
				...
				var push_ = A2(
					...
					payload,
					A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'new:msg', 'dividasaurus:tickets'));
			...
			default:
				var updatedTicket = A2(
					_elm_lang$core$Result$withDefault,
					_user$project$Main$nullTicket,
					A2(
						_elm_lang$core$Json_Decode$decodeString,
						_user$project$Main$ticketDecoder,
				...
				var gameOwner = A2(
					_user$project$Main$userNameFromId,
					_elm_lang$core$Array$toList(model.users),
					A2(_elm_lang$core$Maybe$withDefault, -1, updatedTicket.userId));
				var flashString = A2(
					_elm_lang$core$Basics_ops['++'],
					gameOwner,
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								' (',
								A2(_elm_lang$core$Basics_ops['++'], updatedTicket.opponent, ')')))));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
