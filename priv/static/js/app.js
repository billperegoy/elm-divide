...
require.register("frontend/dist/bundle.js", function(exports, require, module) {
'use strict';
...
(function () {
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Helpers$emptyPayload = _elm_lang$core$Json_Encode$object({ ctor: '[]' });
	var _fbonetti$elm_phoenix_socket$Phoenix_Helpers$maybeInt = function _fbonetti$elm_phoenix_socket$Phoenix_Helpers$maybeInt(maybe) {
		var _p0 = maybe;
		if (_p0.ctor === 'Just') {
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Helpers$messageEncoder = function _fbonetti$elm_phoenix_socket$Phoenix_Helpers$messageEncoder(_p1) {
		var _p2 = _p1;
		return _elm_lang$core$Json_Encode$object({
			ctor: '::',
			_0: {
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Helpers$encodeMessage = function _fbonetti$elm_phoenix_socket$Phoenix_Helpers$encodeMessage(_p3) {
		return A2(_elm_lang$core$Json_Encode$encode, 0, _fbonetti$elm_phoenix_socket$Phoenix_Helpers$messageEncoder(_p3));
	};
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Helpers$Message = F4(function (a, b, c, d) {
		return { event: a, topic: b, payload: c, ref: d };
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Helpers$messageDecoder = A5(_elm_lang$core$Json_Decode$map4, _fbonetti$elm_phoenix_socket$Phoenix_Helpers$Message, A2(_elm_lang$core$Json_Decode$field, 'event', _elm_lang$core$Json_Decode$string), A2(_elm_lang$core$Json_Decode$field, 'topic', _elm_lang$core$Json_Decode$string), A2(_elm_lang$core$Json_Decode$field, 'payload', _elm_lang$core$Json_Decode$value), A2(_elm_lang$core$Json_Decode$field, 'ref', _fbonetti$elm_phoenix_socket$Phoenix_Helpers$nullOrInt));

	var _fbonetti$elm_phoenix_socket$Phoenix_Channel$setState = F2(function (state, channel) {
		return _elm_lang$core$Native_Utils.update(channel, { state: state });
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Channel$map = F2(function (fn, channel) {
		return _elm_lang$core$Native_Utils.update(channel, {
			onClose: A2(_elm_lang$core$Maybe$map, F2(function (x, y) {
				return function (_p0) {
					return x(y(_p0));
				};
			})(fn), channel.onClose),
			onError: A2(_elm_lang$core$Maybe$map, F2(function (x, y) {
				return function (_p1) {
					return x(y(_p1));
				};
			})(fn), channel.onError),
			onJoin: A2(_elm_lang$core$Maybe$map, F2(function (x, y) {
				return function (_p2) {
					return x(y(_p2));
				};
			})(fn), channel.onJoin),
			onJoinError: A2(_elm_lang$core$Maybe$map, F2(function (x, y) {
				return function (_p3) {
					return x(y(_p3));
				};
			})(fn), channel.onJoinError)
		});
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoinError = F2(function (valueToMsg, channel) {
		return _elm_lang$core$Native_Utils.update(channel, {
			onJoinError: _elm_lang$core$Maybe$Just(valueToMsg)
		});
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoin = F2(function (valueToMsg, channel) {
		return _elm_lang$core$Native_Utils.update(channel, {
			onJoin: _elm_lang$core$Maybe$Just(valueToMsg)
		});
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Channel$onClose = F2(function (valueToMsg, channel) {
		return _elm_lang$core$Native_Utils.update(channel, {
			onClose: _elm_lang$core$Maybe$Just(valueToMsg)
		});
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Channel$onError = F2(function (valueToMsg, channel) {
		return _elm_lang$core$Native_Utils.update(channel, {
			onError: _elm_lang$core$Maybe$Just(valueToMsg)
		});
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Channel$withPayload = F2(function (payload, channel) {
		return _elm_lang$core$Native_Utils.update(channel, { payload: payload });
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Channel$Channel = F9(function (a, b, c, d, e, f, g, h, i) {
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Channel$init = function _fbonetti$elm_phoenix_socket$Phoenix_Channel$init(name) {
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Push$map = F2(function (fn, push) {
		return _elm_lang$core$Native_Utils.update(push, {
			onOk: A2(_elm_lang$core$Maybe$map, F2(function (x, y) {
				return function (_p0) {
					return x(y(_p0));
				};
			})(fn), push.onOk),
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Push$onError = F2(function (valueToMsg, push) {
		return _elm_lang$core$Native_Utils.update(push, {
			onError: _elm_lang$core$Maybe$Just(valueToMsg)
		});
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Push$onOk = F2(function (valueToMsg, push) {
		return _elm_lang$core$Native_Utils.update(push, {
			onOk: _elm_lang$core$Maybe$Just(valueToMsg)
		});
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload = F2(function (payload, push) {
		return _elm_lang$core$Native_Utils.update(push, { payload: payload });
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Push$Push = F5(function (a, b, c, d, e) {
		return { event: a, channel: b, payload: c, onOk: d, onError: e };
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Push$init = F2(function (event, channel) {
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$map = F2(function (fn, socket) {
		return _elm_lang$core$Native_Utils.update(socket, {
			channels: A2(_elm_lang$core$Dict$map, F2(function (_p0, channel) {
				return A2(_fbonetti$elm_phoenix_socket$Phoenix_Channel$map, fn, channel);
			}), socket.channels),
			events: A2(_elm_lang$core$Dict$map, F2(function (_p1, event) {
				return function (_p2) {
					return fn(event(_p2));
				};
			}), socket.events),
			pushes: A2(_elm_lang$core$Dict$map, F2(function (_p3, push) {
				return A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$map, fn, push);
			}), socket.pushes)
		});
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$replyDecoder = A3(_elm_lang$core$Json_Decode$map2, F2(function (v0, v1) {
		return { ctor: '_Tuple2', _0: v0, _1: v1 };
	}), A2(_elm_lang$core$Json_Decode$field, 'status', _elm_lang$core$Json_Decode$string), A2(_elm_lang$core$Json_Decode$field, 'response', _elm_lang$core$Json_Decode$value));
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$decodeMessage = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$decodeMessage(_p4) {
		return _elm_lang$core$Result$toMaybe(A2(_elm_lang$core$Json_Decode$decodeString, _fbonetti$elm_phoenix_socket$Phoenix_Helpers$messageDecoder, _p4));
	};
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$debugIfEnabled = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$debugIfEnabled(socket) {
		return socket.debug ? _elm_lang$core$Debug$log('phx_message') : _elm_lang$core$Basics$identity;
	};
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$phoenixMessages = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$phoenixMessages(socket) {
		return A2(_elm_lang$websocket$WebSocket$listen, socket.path, _fbonetti$elm_phoenix_socket$Phoenix_Socket$decodeMessage);
	};
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$mapAll = F2(function (fn, internalMsg) {
		var _p5 = internalMsg;
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$sendMessage = F2(function (path, message) {
		return A2(_elm_lang$websocket$WebSocket$send, path, _fbonetti$elm_phoenix_socket$Phoenix_Helpers$encodeMessage(message));
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$send = F4(function (_p6, event, channel, payload) {
		var _p7 = _p6;
		return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$sendMessage, _p7.path, A4(_fbonetti$elm_phoenix_socket$Phoenix_Helpers$Message, event, channel, payload, _elm_lang$core$Maybe$Just(_p7.ref)));
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$off = F3(function (eventName, channelName, socket) {
		return _elm_lang$core$Native_Utils.update(socket, {
			events: A2(_elm_lang$core$Dict$remove, { ctor: '_Tuple2', _0: eventName, _1: channelName }, socket.events)
		});
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$on = F4(function (eventName, channelName, onReceive, socket) {
		return _elm_lang$core$Native_Utils.update(socket, {
			events: A3(_elm_lang$core$Dict$insert, { ctor: '_Tuple2', _0: eventName, _1: channelName }, onReceive, socket.events)
		});
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$push = F2(function (push_, socket) {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(socket, {
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$heartbeat = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$heartbeat(socket) {
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$leave = F2(function (channelName, socket) {
		...
		if (_p8.ctor === 'Just') {
			...
			if (_elm_lang$core$Native_Utils.eq(_p9.state, _fbonetti$elm_phoenix_socket$Phoenix_Channel$Joining) || _elm_lang$core$Native_Utils.eq(_p9.state, _fbonetti$elm_phoenix_socket$Phoenix_Channel$Joined)) {
				var channel_ = _elm_lang$core$Native_Utils.update(_p9, { state: _fbonetti$elm_phoenix_socket$Phoenix_Channel$Leaving, leaveRef: socket.ref });
				var socket_ = _elm_lang$core$Native_Utils.update(socket, {
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$joinChannel = F2(function (channel, socket) {
		var channel_ = _elm_lang$core$Native_Utils.update(channel, { state: _fbonetti$elm_phoenix_socket$Phoenix_Channel$Joining, joinRef: socket.ref });
		var socket_ = _elm_lang$core$Native_Utils.update(socket, {
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$join = F2(function (channel, socket) {
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$withoutHeartbeat = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$withoutHeartbeat(socket) {
		return _elm_lang$core$Native_Utils.update(socket, { withoutHeartbeat: true });
	};
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$withHeartbeatInterval = F2(function (intervalSeconds, socket) {
		return _elm_lang$core$Native_Utils.update(socket, { heartbeatIntervalSeconds: intervalSeconds });
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(socket) {
		return _elm_lang$core$Native_Utils.update(socket, { debug: true });
	};
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$update = F2(function (msg, socket) {
		var _p12 = msg;
		switch (_p12.ctor) {
			case 'ChannelErrored':
				var channels = A3(_elm_lang$core$Dict$update, _p12._0, _elm_lang$core$Maybe$map(_fbonetti$elm_phoenix_socket$Phoenix_Channel$setState(_fbonetti$elm_phoenix_socket$Phoenix_Channel$Errored)), socket.channels);
				var socket_ = _elm_lang$core$Native_Utils.update(socket, { channels: channels });
			...
			case 'ChannelClosed':
				...
				if (_p13.ctor === 'Just') {
					...
					var channels = A3(_elm_lang$core$Dict$insert, _p15, A2(_fbonetti$elm_phoenix_socket$Phoenix_Channel$setState, _fbonetti$elm_phoenix_socket$Phoenix_Channel$Closed, _p14), socket.channels);
					var socket_ = _elm_lang$core$Native_Utils.update(socket, { channels: channels, pushes: pushes });
					return { ctor: '_Tuple2', _0: socket_, _1: _elm_lang$core$Platform_Cmd$none };
				} else {
					return { ctor: '_Tuple2', _0: socket, _1: _elm_lang$core$Platform_Cmd$none };
				}
			case 'ChannelJoined':
				...
				if (_p16.ctor === 'Just') {
					...
					var channels = A3(_elm_lang$core$Dict$insert, _p18, A2(_fbonetti$elm_phoenix_socket$Phoenix_Channel$setState, _fbonetti$elm_phoenix_socket$Phoenix_Channel$Joined, _p17), socket.channels);
					var socket_ = _elm_lang$core$Native_Utils.update(socket, { channels: channels, pushes: pushes });
					return { ctor: '_Tuple2', _0: socket_, _1: _elm_lang$core$Platform_Cmd$none };
				} else {
					return { ctor: '_Tuple2', _0: socket, _1: _elm_lang$core$Platform_Cmd$none };
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$init = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$init(path) {
		return {
			path: path,
			debug: false,
			channels: _elm_lang$core$Dict$fromList({ ctor: '[]' }),
			events: _elm_lang$core$Dict$fromList({ ctor: '[]' }),
			pushes: _elm_lang$core$Dict$fromList({ ctor: '[]' }),
			ref: 0,
			heartbeatIntervalSeconds: 30,
			withoutHeartbeat: false
		};
	};
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$Socket = F8(function (a, b, c, d, e, f, g, h) {
		return { path: a, debug: b, channels: c, events: d, pushes: e, ref: f, heartbeatIntervalSeconds: g, withoutHeartbeat: h };
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$Heartbeat = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$Heartbeat(a) {
		return { ctor: 'Heartbeat', _0: a };
	};
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$heartbeatSubscription = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$heartbeatSubscription(socket) {
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$ReceiveReply = F2(function (a, b) {
		return { ctor: 'ReceiveReply', _0: a, _1: b };
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelJoined = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelJoined(a) {
		return { ctor: 'ChannelJoined', _0: a };
	};
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelClosed = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelClosed(a) {
		return { ctor: 'ChannelClosed', _0: a };
	};
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelErrored = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelErrored(a) {
		return { ctor: 'ChannelErrored', _0: a };
	};
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg(a) {
		return { ctor: 'ExternalMsg', _0: a };
	};
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp = { ctor: 'NoOp' };
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$handleInternalPhxReply = F2(function (socket, message) {
		var msg = A2(_elm_lang$core$Maybe$andThen, function (_p19) {
			var _p20 = _p19;
			return A2(_elm_lang$core$Maybe$andThen, function (ref) {
				return A2(_elm_lang$core$Maybe$andThen, function (channel) {
					return _elm_lang$core$Native_Utils.eq(_p20._0, 'ok') ? _elm_lang$core$Native_Utils.eq(ref, channel.joinRef) ? _elm_lang$core$Maybe$Just(_fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelJoined(message.topic)) : _elm_lang$core$Native_Utils.eq(ref, channel.leaveRef) ? _elm_lang$core$Maybe$Just(_fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelClosed(message.topic)) : _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Nothing;
				}, A2(_elm_lang$core$Dict$get, message.topic, socket.channels));
			}, message.ref);
		}, _elm_lang$core$Result$toMaybe(A2(_elm_lang$core$Json_Decode$decodeValue, _fbonetti$elm_phoenix_socket$Phoenix_Socket$replyDecoder, message.payload)));
		return A2(_elm_lang$core$Maybe$withDefault, _fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp, msg);
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$mapInternalMsgs = F2(function (socket, maybeMessage) {
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$internalMsgs = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$internalMsgs(socket) {
		return A2(_elm_lang$core$Platform_Sub$map, _fbonetti$elm_phoenix_socket$Phoenix_Socket$mapInternalMsgs(socket), _fbonetti$elm_phoenix_socket$Phoenix_Socket$phoenixMessages(socket));
	};
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$handlePhxReply = F2(function (socket, message) {
		var msg = A2(_elm_lang$core$Maybe$andThen, function (_p24) {
			var _p25 = _p24;
			var _p29 = _p25._1;
			return A2(_elm_lang$core$Maybe$andThen, function (ref) {
				return A2(_elm_lang$core$Maybe$andThen, function (push) {
					var _p26 = _p25._0;
					switch (_p26) {
						case 'ok':
							return A2(_elm_lang$core$Maybe$map, function (f) {
								return function (_p27) {
									return _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg(f(_p27));
								}(_p29);
							}, push.onOk);
						case 'error':
							return A2(_elm_lang$core$Maybe$map, function (f) {
								return function (_p28) {
									return _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg(f(_p28));
								}(_p29);
							}, push.onError);
						default:
							return _elm_lang$core$Maybe$Nothing;
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$handleEvent = F2(function (socket, message) {
		var _p30 = A2(_elm_lang$core$Dict$get, { ctor: '_Tuple2', _0: message.event, _1: message.topic }, socket.events);
		if (_p30.ctor === 'Just') {
			return _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg(_p30._0(message.payload));
		} else {
			return _fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp;
		}
	});
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$mapExternalMsgs = F2(function (socket, maybeMessage) {
		...
		if (_p31.ctor === 'Just') {
			...
			switch (_p32) {
				...
				case 'phx_error':
					...
					var onError = A2(_elm_lang$core$Maybe$andThen, function (_) {
						return _.onError;
					}, channel);
					var msg = A2(_elm_lang$core$Maybe$map, function (f) {
						return function (_p33) {
							return _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg(f(_p33));
						}(_p35.payload);
					}, onError);
					return A2(_elm_lang$core$Maybe$withDefault, _fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp, msg);
				case 'phx_close':
					var channel = A2(_elm_lang$core$Dict$get, _p35.topic, socket.channels);
					var onClose = A2(_elm_lang$core$Maybe$andThen, function (_) {
						return _.onClose;
					}, channel);
					var msg = A2(_elm_lang$core$Maybe$map, function (f) {
						return function (_p34) {
							return _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg(f(_p34));
						}(_p35.payload);
					}, onClose);
					return A2(_elm_lang$core$Maybe$withDefault, _fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp, msg);
				default:
	...
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$externalMsgs = function _fbonetti$elm_phoenix_socket$Phoenix_Socket$externalMsgs(socket) {
		return A2(_elm_lang$core$Platform_Sub$map, _fbonetti$elm_phoenix_socket$Phoenix_Socket$mapExternalMsgs(socket), _fbonetti$elm_phoenix_socket$Phoenix_Socket$phoenixMessages(socket));
	};
	var _fbonetti$elm_phoenix_socket$Phoenix_Socket$listen = F2(function (socket, fn) {
		return function (_p36) {
			return A2(_elm_lang$core$Platform_Sub$map, _fbonetti$elm_phoenix_socket$Phoenix_Socket$mapAll(fn), _elm_lang$core$Platform_Sub$batch(_p36));
		}({
			ctor: '::',
	...
	var _user$project$Main$onClickNoDefault = function _user$project$Main$onClickNoDefault(message) {
		var config = { stopPropagation: true, preventDefault: true };
		return A3(_elm_lang$html$Html_Events$onWithOptions, 'click', config, _elm_lang$core$Json_Decode$succeed(message));
	};
	var _user$project$Main$useHeroku = true;
	...
	var _user$project$Main$header = function _user$project$Main$header(model) {
		...
		return A2(_elm_lang$html$Html$div, { ctor: '[]' }, {
			...
			_0: A2(_elm_lang$html$Html$div, {
				...
				_0: A2(_elm_lang$html$Html$h1, { ctor: '[]' }, {
					ctor: '::',
					_0: _elm_lang$html$Html$text('Dividasaurus'),
					_1: { ctor: '[]' }
				}),
				_1: { ctor: '[]' }
			}),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html$div, errorAttributes, {
					ctor: '::',
					_0: _elm_lang$html$Html$text(model.systemError),
					_1: { ctor: '[]' }
				}),
				_1: { ctor: '[]' }
			}
	...
	var _user$project$Main$flashViewElements = function _user$project$Main$flashViewElements(elements) {
		return A2(_elm_lang$core$List$map, function (elem) {
			return A2(_elm_lang$html$Html$div, {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(A2(_elm_lang$core$Basics_ops['++'], 'alert alert-', elem.color)),
				_1: { ctor: '[]' }
			}, {
				ctor: '::',
				_0: _elm_lang$html$Html$text(elem.text),
				_1: { ctor: '[]' }
			});
		}, elements);
	};
	var _user$project$Main$durationString = function _user$project$Main$durationString(val) {
		return _elm_lang$core$Native_Utils.eq(val, 0) ? '' : _elm_lang$core$Basics$toString(val);
	};
	var _user$project$Main$markTicketSelected = F3(function (ticket, id, userId) {
		return _elm_lang$core$Native_Utils.eq(ticket.id, id) ? _elm_lang$core$Native_Utils.update(ticket, {
			userId: _elm_lang$core$Maybe$Just(userId)
		}) : ticket;
	});
	var _user$project$Main$nullUser = { id: -1, name: 'guest' };
	var _user$project$Main$myTurn = function _user$project$Main$myTurn(model) {
		var currentUserName = function (_) {
			return _.name;
		}(A2(_elm_lang$core$Maybe$withDefault, _user$project$Main$nullUser, A2(_elm_lang$core$Array$get, model.currentUser, model.users)));
		return _elm_lang$core$Native_Utils.eq(currentUserName, model.myUserName);
	};
	var _user$project$Main$userNameFromId = F2(function (users, id) {
		return function (_) {
			return _.name;
		}(A2(_elm_lang$core$Maybe$withDefault, _user$project$Main$nullUser, _elm_lang$core$List$head(A2(_elm_lang$core$List$filter, function (user) {
			return _elm_lang$core$Native_Utils.eq(user.id, id);
		}, users))));
	});
	var _user$project$Main$userIdFromName = F2(function (name, users) {
		return function (_) {
			return _.id;
		}(A2(_elm_lang$core$Maybe$withDefault, _user$project$Main$nullUser, _elm_lang$core$List$head(A2(_elm_lang$core$List$filter, function (user) {
			return _elm_lang$core$Native_Utils.eq(user.name, name);
		}, users))));
	});
	var _user$project$Main$userField = F3(function (model, index, extractor) {
		return extractor(A2(_elm_lang$core$Maybe$withDefault, _user$project$Main$nullUser, A2(_elm_lang$core$Array$get, index, model.users)));
	});
	var _user$project$Main$nullTicket = { id: -1, date: 'no date', opponent: 'no opponent', time: 'no time', userId: _elm_lang$core$Maybe$Nothing };
	var _user$project$Main$FlashElement = F4(function (a, b, c, d) {
		return { id: a, text: b, color: c, duration: d };
	});
	var _user$project$Main$Ticket = F5(function (a, b, c, d, e) {
		return { id: a, date: b, opponent: c, time: d, userId: e };
	});
	var _user$project$Main$ticketDecoder = A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'user_id', _elm_lang$core$Json_Decode$nullable(_elm_lang$core$Json_Decode$int), A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'time', _elm_lang$core$Json_Decode$string, A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'opponent', _elm_lang$core$Json_Decode$string, A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'date', _elm_lang$core$Json_Decode$string, A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'id', _elm_lang$core$Json_Decode$int, _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Ticket))))));
	var _user$project$Main$ticketListDecoder = _elm_lang$core$Json_Decode$list(_user$project$Main$ticketDecoder);
	var _user$project$Main$User = F2(function (a, b) {
		return { id: a, name: b };
	});
	var _user$project$Main$userDecoder = A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'name', _elm_lang$core$Json_Decode$string, A3(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required, 'id', _elm_lang$core$Json_Decode$int, _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$User)));
	var _user$project$Main$userListDecoder = _elm_lang$core$Json_Decode$list(_user$project$Main$userDecoder);
						...
						return function (f) {
							return function (g) {
								return function (h) {
									return function (i) {
										return function (j) {
											return { tickets: a, flashElements: b, nextId: c, users: d, currentUser: e, myUserId: f, myUserName: g, systemError: h, userInputField: i, phxSocket: j };
										};
									};
								};
							};
	...
	var _user$project$Main$ReceiveMessage = function _user$project$Main$ReceiveMessage(a) {
		return { ctor: 'ReceiveMessage', _0: a };
	};
	var _user$project$Main$initPhoenixSocket = A4(_fbonetti$elm_phoenix_socket$Phoenix_Socket$on, 'ticket_select', 'dividasaurus:tickets', _user$project$Main$ReceiveMessage, _fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(_fbonetti$elm_phoenix_socket$Phoenix_Socket$init(A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$wsBase, '/socket/websocket'))));
	var _user$project$Main$SendMessage = F2(function (a, b) {
		return { ctor: 'SendMessage', _0: a, _1: b };
	});
	var _user$project$Main$singleTicket = F3(function (ticket, myUserId, myTurn) {
		var innerDiv = A2(_elm_lang$html$Html$div, {
			ctor: '::',
			...
			_0: A2(_elm_lang$html$Html$div, {
				...
				_0: A2(_elm_lang$html$Html$div, { ctor: '[]' }, {
					ctor: '::',
					_0: _elm_lang$html$Html$text(ticket.date),
					_1: { ctor: '[]' }
				}),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html$div, { ctor: '[]' }, {
						ctor: '::',
						_0: _elm_lang$html$Html$text(ticket.opponent),
						_1: { ctor: '[]' }
					}),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html$div, { ctor: '[]' }, {
							ctor: '::',
							_0: _elm_lang$html$Html$text(ticket.time),
							_1: { ctor: '[]' }
						}),
						_1: { ctor: '[]' }
					}
		...
		return myTurn ? A2(_elm_lang$html$Html$a, {
			ctor: '::',
			_0: _user$project$Main$onClickNoDefault(A2(_user$project$Main$SendMessage, ticket.id, myUserId)),
			_1: {
				ctor: '::',
	...
	var _user$project$Main$ticketList = F3(function (myUserId, myTurn, tickets) {
		return A2(_elm_lang$core$List$map, function (ticket) {
			return A3(_user$project$Main$singleTicket, ticket, myUserId, myTurn);
		}, tickets);
	});
	var _user$project$Main$remainingTickets = F3(function (tickets, myUserId, myTurn) {
		var remainingTickets = A2(_elm_lang$core$List$filter, function (ticket) {
			return _elm_lang$core$Native_Utils.eq(ticket.userId, _elm_lang$core$Maybe$Nothing);
		}, tickets);
		var remainingCount = _elm_lang$core$List$length(remainingTickets);
		return A2(_elm_lang$html$Html$div, {
			ctor: '::',
			...
			_0: A2(_elm_lang$html$Html$h1, {
				...
				_0: A2(_elm_lang$html$Html$span, {
					...
					ctor: '::',
					_0: _elm_lang$html$Html$text(A2(_elm_lang$core$Basics_ops['++'], 'Remaining Tickets - ', _elm_lang$core$Basics$toString(remainingCount))),
					_1: { ctor: '[]' }
				}),
				_1: { ctor: '[]' }
			}),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html$div, { ctor: '[]' }, A3(_user$project$Main$ticketList, myUserId, myTurn, remainingTickets)),
				_1: { ctor: '[]' }
			}
		});
	});
	var _user$project$Main$myTickets = function _user$project$Main$myTickets(model) {
		var myTickets = A2(_elm_lang$core$List$filter, function (ticket) {
			return _elm_lang$core$Native_Utils.eq(ticket.userId, _elm_lang$core$Maybe$Just(model.myUserId));
		}, model.tickets);
		var ticketCount = _elm_lang$core$List$length(myTickets);
		return A2(_elm_lang$html$Html$div, {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('col-md-4'),
			_1: { ctor: '[]' }
			...
			_0: A2(_elm_lang$html$Html$h1, {
				...
				_0: A2(_elm_lang$html$Html$span, {
					...
					ctor: '::',
					_0: _elm_lang$html$Html$text(A2(_elm_lang$core$Basics_ops['++'], 'My Tickets - ', _elm_lang$core$Basics$toString(ticketCount))),
					_1: { ctor: '[]' }
				}),
				_1: { ctor: '[]' }
			}),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html$div, { ctor: '[]' }, A3(_user$project$Main$ticketList, model.myUserId, false, myTickets)),
				_1: { ctor: '[]' }
			}
		});
	};
	var _user$project$Main$JoinChannel = { ctor: 'JoinChannel' };
	var _user$project$Main$joinChannel = A2(_elm_lang$core$Task$perform, _elm_lang$core$Basics$identity, _elm_lang$core$Task$succeed(_user$project$Main$JoinChannel));
	var _user$project$Main$PhoenixMsg = function _user$project$Main$PhoenixMsg(a) {
	...
	var _user$project$Main$ProcessUserRequest = function _user$project$Main$ProcessUserRequest(a) {
	...
	var _user$project$Main$usersRequest = function () {
		...
		return A2(_elm_lang$http$Http$send, _user$project$Main$ProcessUserRequest, A2(_elm_lang$http$Http$get, url, _user$project$Main$userListDecoder));
	}();
	var _user$project$Main$ProcessTicketRequest = function _user$project$Main$ProcessTicketRequest(a) {
	...
	var _user$project$Main$ticketsRequest = function () {
		...
		return A2(_elm_lang$http$Http$send, _user$project$Main$ProcessTicketRequest, A2(_elm_lang$http$Http$get, url, _user$project$Main$ticketListDecoder));
	}();
	var _user$project$Main$init = A2(_elm_lang$core$Platform_Cmd_ops['!'], {
		tickets: { ctor: '[]' },
		flashElements: { ctor: '[]' },
		nextId: 0,
		users: _elm_lang$core$Array$fromList({ ctor: '[]' }),
		currentUser: 0,
		myUserId: -1,
		myUserName: '',
		systemError: '',
		...
		ctor: '::',
		_0: _user$project$Main$ticketsRequest,
		_1: {
			ctor: '::',
			_0: _user$project$Main$usersRequest,
			_1: {
				ctor: '::',
				_0: _user$project$Main$joinChannel,
				_1: { ctor: '[]' }
			}
		}
	});
	var _user$project$Main$SubmitUserInputField = { ctor: 'SubmitUserInputField' };
	var _user$project$Main$UpdateUserInputField = function _user$project$Main$UpdateUserInputField(a) {
		return { ctor: 'UpdateUserInputField', _0: a };
	};
	var _user$project$Main$NextUser = { ctor: 'NextUser' };
	var _user$project$Main$userPlusButton = function _user$project$Main$userPlusButton(model) {
		var loginClass = _elm_lang$core$Native_Utils.eq(model.myUserName, '') ? 'label label-danger' : 'label label-default';
		var loginText = _elm_lang$core$Native_Utils.eq(model.myUserName, '') ? 'Please Login' : A2(_elm_lang$core$Basics_ops['++'], 'Logged In: ', model.myUserName);
		return {
			ctor: '::',
			_0: A2(_elm_lang$html$Html$input, {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$UpdateUserInputField),
				_1: { ctor: '[]' }
			}, { ctor: '[]' }),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html$button, {
					ctor: '::',
					_0: _user$project$Main$onClickNoDefault(_user$project$Main$SubmitUserInputField),
					_1: { ctor: '[]' }
				}, {
					ctor: '::',
				...
				_1: {
					...
					_0: A2(_elm_lang$html$Html$h3, { ctor: '[]' }, {
						...
						_0: A2(_elm_lang$html$Html$span, {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(loginClass),
							_1: { ctor: '[]' }
						}, {
							ctor: '::',
					...
					_1: {
						...
						_0: A2(_elm_lang$html$Html$h3, { ctor: '[]' }, {
							...
							_0: A2(_elm_lang$html$Html$span, {
								...
								ctor: '::',
								_0: _elm_lang$html$Html$text(A2(_elm_lang$core$Basics_ops['++'], 'Up Now: ', A3(_user$project$Main$userField, model, model.currentUser, function (_) {
									return _.name;
								}))),
								_1: { ctor: '[]' }
							}),
						...
						_1: {
							...
							_0: A2(_elm_lang$html$Html$button, {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Main$onClickNoDefault(_user$project$Main$NextUser),
									_1: { ctor: '[]' }
								}
							}, {
								ctor: '::',
								_0: _elm_lang$html$Html$text('Next User'),
								_1: { ctor: '[]' }
							}),
							_1: { ctor: '[]' }
						}
	...
	var _user$project$Main$flashView = function _user$project$Main$flashView(model) {
		return A2(_elm_lang$html$Html$div, {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('col-md-2'),
			_1: { ctor: '[]' }
		}, A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$userPlusButton(model), _user$project$Main$flashViewElements(model.flashElements)));
	};
	var _user$project$Main$view = function _user$project$Main$view(model) {
		var itsMyTurn = _user$project$Main$myTurn(model);
		return A2(_elm_lang$html$Html$div, {
			ctor: '::',
			...
			_1: {
				...
				_0: A2(_elm_lang$html$Html$div, {
					...
					ctor: '::',
					_0: _user$project$Main$flashView(model),
					_1: {
						ctor: '::',
						_0: A3(_user$project$Main$remainingTickets, model.tickets, model.myUserId, itsMyTurn),
						_1: {
							ctor: '::',
							_0: _user$project$Main$myTickets(model),
							_1: { ctor: '[]' }
						}
					}
				}),
	...
	var _user$project$Main$DeleteFlashElement = F2(function (a, b) {
		return { ctor: 'DeleteFlashElement', _0: a, _1: b };
	});
	var _user$project$Main$deleteCmd = F2(function (id, duration) {
		return A2(_elm_lang$core$Task$perform, function (_p0) {
			return A2(_user$project$Main$DeleteFlashElement, id, duration);
		}, _elm_lang$core$Process$sleep(duration * _elm_lang$core$Time$second));
	});
	var _user$project$Main$CreateFlashElement = F3(function (a, b, c) {
		return { ctor: 'CreateFlashElement', _0: a, _1: b, _2: c };
	});
	var _user$project$Main$createFlashElement = F3(function (message, color, duration) {
		return A2(_elm_lang$core$Task$perform, _elm_lang$core$Basics$identity, _elm_lang$core$Task$succeed(A3(_user$project$Main$CreateFlashElement, message, color, duration)));
	});
	var _user$project$Main$update = F2(function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'NextUser':
				var length = _elm_lang$core$Array$length(model.users);
				var nextUser = _elm_lang$core$Native_Utils.eq(model.currentUser, length - 1) ? 0 : model.currentUser + 1;
				var nextUserName = A3(_user$project$Main$userField, model, nextUser, function (_) {
					return _.name;
				});
				var color = _elm_lang$core$Native_Utils.eq(nextUserName, model.myUserName) ? 'danger' : 'info';
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { currentUser: nextUser }), {
					ctor: '::',
					_0: A3(_user$project$Main$createFlashElement, A2(_elm_lang$core$Basics_ops['++'], nextUserName, '\'s turn'), color, 20),
					_1: { ctor: '[]' }
				});
			case 'UpdateUserInputField':
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { userInputField: _p1._0 }), { ctor: '[]' });
			case 'SubmitUserInputField':
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, {
					myUserName: model.userInputField,
					userInputField: '',
					myUserId: A2(_user$project$Main$userIdFromName, model.userInputField, _elm_lang$core$Array$toList(model.users))
				}), { ctor: '[]' });
			case 'CreateFlashElement':
				var newFlashElement = { id: model.nextId, text: _p1._0, color: _p1._1, duration: _p1._2 };
				var newList = { ctor: '::', _0: newFlashElement, _1: model.flashElements };
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { flashElements: newList, nextId: model.nextId + 1 }), {
					ctor: '::',
					_0: A2(_user$project$Main$deleteCmd, model.nextId, newFlashElement.duration),
					_1: { ctor: '[]' }
				});
			case 'DeleteFlashElement':
				var newList = A2(_elm_lang$core$List$filter, function (elem) {
					return !_elm_lang$core$Native_Utils.eq(elem.id, _p1._0);
				}, model.flashElements);
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { flashElements: newList }), { ctor: '[]' });
			case 'ProcessTicketRequest':
				if (_p1._0.ctor === 'Ok') {
					return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { tickets: _p1._0._0 }), { ctor: '[]' });
				} else {
					var errorString = A3(_elm_lang$core$String$slice, 0, 120, _elm_lang$core$Basics$toString(_p1._0._0));
					return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { systemError: errorString }), { ctor: '[]' });
				}
			case 'ProcessUserRequest':
				if (_p1._0.ctor === 'Ok') {
					return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, {
						users: _elm_lang$core$Array$fromList(_p1._0._0)
					}), { ctor: '[]' });
				} else {
					var errorString = A3(_elm_lang$core$String$slice, 0, 120, _elm_lang$core$Basics$toString(_p1._0._0));
					return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { systemError: errorString }), { ctor: '[]' });
			...
			case 'PhoenixMsg':
				...
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(model, { phxSocket: phxSocket }),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PhoenixMsg, phxCmd)
				};
			case 'JoinChannel':
				var channel = _fbonetti$elm_phoenix_socket$Phoenix_Channel$init('dividasaurus:tickets');
			...
			case 'SendMessage':
				...
				var push_ = A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload, payload, A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'ticket_select', 'dividasaurus:tickets'));
				var _p4 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push_, model.phxSocket);
				var phxSocket = _p4._0;
				var phxCmd = _p4._1;
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { phxSocket: phxSocket }), {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PhoenixMsg, phxCmd),
					_1: { ctor: '[]' }
				});
			default:
				var updatedTicket = A2(_elm_lang$core$Result$withDefault, _user$project$Main$nullTicket, A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$ticketDecoder, A2(_elm_lang$core$Json_Encode$encode, 0, _p1._0)));
				var newTickets = A2(_elm_lang$core$List$map, function (ticket) {
					return _elm_lang$core$Native_Utils.eq(ticket.id, updatedTicket.id) ? updatedTicket : ticket;
				}, model.tickets);
				var gameDate = updatedTicket.date;
				var gameOwner = A2(_user$project$Main$userNameFromId, _elm_lang$core$Array$toList(model.users), A2(_elm_lang$core$Maybe$withDefault, -1, updatedTicket.userId));
				var flashString = A2(_elm_lang$core$Basics_ops['++'], gameOwner, A2(_elm_lang$core$Basics_ops['++'], ' chose ', A2(_elm_lang$core$Basics_ops['++'], gameDate, A2(_elm_lang$core$Basics_ops['++'], ' (', A2(_elm_lang$core$Basics_ops['++'], updatedTicket.opponent, ')')))));
				return A2(_elm_lang$core$Platform_Cmd_ops['!'], _elm_lang$core$Native_Utils.update(model, { tickets: newTickets }), {
					ctor: '::',
					_0: A3(_user$project$Main$createFlashElement, flashString, 'info', 20),
					_1: { ctor: '[]' }
				});
		}
	});
	...
	if (typeof _user$project$Main$main !== 'undefined') {
		_user$project$Main$main(Elm['Main'], 'Main', { "types": { "unions": { "Dict.LeafColor": { "args": [], "tags": { "LBBlack": [], "LBlack": [] } }, "Json.Encode.Value": { "args": [], "tags": { "Value": [] } }, "Dict.Dict": { "args": ["k", "v"], "tags": { "RBNode_elm_builtin": ["Dict.NColor", "k", "v", "Dict.Dict k v", "Dict.Dict k v"], "RBEmpty_elm_builtin": ["Dict.LeafColor"] } }, "Maybe.Maybe": { "args": ["a"], "tags": { "Just": ["a"], "Nothing": [] } }, "Main.Msg": { "args": [], "tags": { "UpdateUserInputField": ["String"], "SendMessage": ["Int", "Int"], "DeleteFlashElement": ["Int", "Time.Time"], "CreateFlashElement": ["String", "String", "Time.Time"], "ReceiveMessage": ["Json.Encode.Value"], "ProcessTicketRequest": ["Result.Result Http.Error (List Main.Ticket)"], "JoinChannel": [], "SubmitUserInputField": [], "PhoenixMsg": ["Phoenix.Socket.Msg Main.Msg"], "ProcessUserRequest": ["Result.Result Http.Error (List Main.User)"], "NextUser": [] } }, "Dict.NColor": { "args": [], "tags": { "BBlack": [], "Red": [], "NBlack": [], "Black": [] } }, "Http.Error": { "args": [], "tags": { "BadUrl": ["String"], "NetworkError": [], "Timeout": [], "BadStatus": ["Http.Response String"], "BadPayload": ["String", "Http.Response String"] } }, "Result.Result": { "args": ["error", "value"], "tags": { "Ok": ["value"], "Err": ["error"] } }, "Phoenix.Socket.Msg": { "args": ["msg"], "tags": { "ChannelErrored": ["String"], "ChannelClosed": ["String"], "ExternalMsg": ["msg"], "ChannelJoined": ["String"], "Heartbeat": ["Time.Time"], "NoOp": [], "ReceiveReply": ["String", "Int"] } } }, "aliases": { "Main.User": { "args": [], "type": "{ id : Int, name : String }" }, "Http.Response": { "args": ["body"], "type": "{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }" }, "Time.Time": { "args": [], "type": "Float" }, "Main.Ticket": { "args": [], "type": "{ id : Int , date : String , opponent : String , time : String , userId : Maybe.Maybe Int }" } }, "message": "Main.Msg" }, "versions": { "elm": "0.18.0" } });
	}
